...
const foundCharacter = simpsons.find((simpson) => simpson.id === "13dfgd5ab");
// // if (simpson.id === "13dfgd5ab") {
// //   return true;
// // } else {
// //   return false;
// // }
// return simpson.id === "13dfgd5ab";

findOutput.textContent = foundCharacter ? foundCharacter.name : "Nothing found";
